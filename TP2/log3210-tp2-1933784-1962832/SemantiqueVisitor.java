...
public class SemantiqueVisitor implements ParserVisitor {
    ...
    public Object visit(ASTNormalDeclaration node, Object data) {
        ...
        // si on la variable a deja été déclaré
    ...
    public Object visit(ASTForEachStmt node, Object data) {
        ...
        if (!(("list" + iteratorVariableType).equals(listVariableType.name()))) {
            ...
            //déclaration de la variable en argument de la boucle
            node.jjtGetChild(0).jjtAccept(this, data);
        }

        //on visit le block dans le for each
    ...
    */
    ...
    public Object visit(ASTCompExpr node, Object data) {
        ...
        */
        ...
        //Si une comparaison a été fait, alors le data de ce symbole est booléen
        if(data!=null)
